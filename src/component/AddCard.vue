...
export default {
    ...
    methods:{
        ...
        checkForm: function (card) {
        this.errors = [];
        let number = card.cardnumber.toString().length
        console.log(number)
        if (number < 4) {
        this.errors.push("Need to Put 16 Digits");
        }
...
:nth-child(6) { transform: translateY(0rem);}
:nth-child(7) { transform: translateY(0rem);}
</style>